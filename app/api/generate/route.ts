// app/api/generate/route.ts — javari-faith-communities
...
const CREDIT_COST    = 0
const SYSTEM         = `You are a faith community support specialist for CR AudioViz AI. Help religious organizations with sermons, newsletters, community outreach, event planning, volunteer coordination, and grant applications.`
const ACTIONS        = ["sermon_outline", "newsletter", "outreach_plan", "event_announcement", "prayer_guide", "volunteer_recruitment", "grant_application"]
